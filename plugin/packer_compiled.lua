...
_G.packer_plugins = {
  ...
  aylin = {
    loaded = true,
    path = "/home/victor/.local/share/nvim/site/pack/packer/start/aylin",
  ...
  ["copilot.vim"] = {
    loaded = true,
    path = "/home/victor/.local/share/nvim/site/pack/packer/start/copilot.vim",
    url = "https://github.com/github/copilot.vim"
  },
  kanagawa = {
    loaded = true,
    path = "/home/victor/.local/share/nvim/site/pack/packer/start/kanagawa",
  ...
  midnight = {
    loaded = true,
    path = "/home/victor/.local/share/nvim/site/pack/packer/start/midnight",
    url = "https://github.com/dasupradyumna/midnight.nvim"
  },
  moonfly = {
    loaded = true,
    path = "/home/victor/.local/share/nvim/site/pack/packer/start/moonfly",
    url = "https://github.com/bluz71/vim-moonfly-colors"
  },
  noctis = {
    loaded = true,
    path = "/home/victor/.local/share/nvim/site/pack/packer/start/noctis",
  ...
  palenightfall = {
    loaded = true,
    path = "/home/victor/.local/share/nvim/site/pack/packer/start/palenightfall",
  ...
  sonokai = {
    loaded = true,
    path = "/home/victor/.local/share/nvim/site/pack/packer/start/sonokai",
  ...
  ["vim-smoothie"] = {
    loaded = true,
    path = "/home/victor/.local/share/nvim/site/pack/packer/start/vim-smoothie",
    url = "https://github.com/psliwka/vim-smoothie"
  },
  ["vim-tmux-navigator"] = {
    loaded = true,
    path = "/home/victor/.local/share/nvim/site/pack/packer/start/vim-tmux-navigator",
